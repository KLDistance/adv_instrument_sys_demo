...
<Project Type="Project" LVVersion="14008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Multichannel_Scan" Type="Folder">
			<Item Name="Main_MultiSTSWScanning.vi" Type="VI" URL="../Main_MultiSTSWScanning.vi"/>
			<Item Name="Sub_InitChannels.vi" Type="VI" URL="../Sub_InitChannels.vi"/>
			<Item Name="Sub_SaveTXT.vi" Type="VI" URL="../Sub_SaveTXT.vi"/>
			<Item Name="Sub_SaveXLSX.vi" Type="VI" URL="../Sub_SaveXLSX.vi"/>
			<Item Name="Sub_SPCI_str_to_data.vi" Type="VI" URL="../Sub_SPCI_str_to_data.vi"/>
			<Item Name="Sub_StairCaseSweep.vi" Type="VI" URL="../Sub_StairCaseSweep.vi"/>
			<Item Name="Sub_STSWDelayTrigger.vi" Type="VI" URL="../Sub_STSWDelayTrigger.vi"/>
			<Item Name="Sub_TermChannels.vi" Type="VI" URL="../Sub_TermChannels.vi"/>
		</Item>
		<Item Name="Oscillator" Type="Folder">
			<Item Name="Osc_SinWave.vi" Type="VI" URL="../Osc_SinWave.vi"/>
		</Item>
		<Item Name="Pre-test" Type="Folder">
			<Item Name="DataBuffer.vi" Type="VI" URL="../DataBuffer.vi"/>
			<Item Name="SeqWithMultichannel.vi" Type="VI" URL="../SeqWithMultichannel.vi"/>
			<Item Name="SyncTest.vi" Type="VI" URL="../SyncTest.vi"/>
			<Item Name="TestConnection.vi" Type="VI" URL="../TestConnection.vi"/>
			<Item Name="TestOsc.vi" Type="VI" URL="../TestOsc.vi"/>
		</Item>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="LabviewDllTest2_ParallelRunning.dll" Type="Document" URL="../dll/LabviewDllTest2_ParallelRunning.dll"/>
			<Item Name="Save2Darr_to_csv.dll" Type="Document" URL="../dll/Save2Darr_to_csv.dll"/>
		</Item>
